...
class Product_model extends Model
{
	...
	function fetch_join($select = "*", $join_1, $table_1, $on_1, $join_2, $table_2, $on_2, $join_3, $table_3, $on_3, $where = "", $order = "pro_id", $by = "DESC", $start = -1, $limit = 0, $distinct = false)
	{
        $this->db->cache_off();
		$this->db->select($select);
    ...
    function add($data)
	{
		return $this->db->insert("tbtt_product", $data);
	}
