...
<?php if((int)$advertiseArray->adv_position == 3 && trim($advertiseArray->adv_page) != '' && stristr($advertiseArray->adv_page, $advertisePage)){ ?>
<tr>
	<td align="center">
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank" title="<?php echo $advertiseArray->adv_title; ?>">
	        ...
	        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" class="advertise_left_flash" id="FlashID_<?php echo $advertiseArray->adv_id; ?>" title="<?php echo $advertiseArray->adv_title; ?>">
	        ...
	        <?php }else{ ?>
			<img src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" class="advertise_left" />
			<?php } ?>
		</a>
	</td>
</tr>
