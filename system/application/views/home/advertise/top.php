...
<?php if((int)$advertiseArray->adv_position == 5 && trim($advertiseArray->adv_page) != '' && stristr($advertiseArray->adv_page, $advertisePage)){ ?>
<tr>
	<td align="center">
	    <a href="<?php echo prep_url($advertiseArray->adv_link); ?>" target="_blank" title="<?php echo $advertiseArray->adv_title; ?>">
	        ...
	        <?php }else{ ?>
			<img src="<?php echo base_url(); ?>media/banners/<?php echo $advertiseArray->adv_dir; ?>/<?php echo $advertiseArray->adv_banner; ?>" class="advertise_top" />
			<?php } ?>
		</a>
	</td>
</tr>
