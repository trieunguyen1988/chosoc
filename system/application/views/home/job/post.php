        ...
        <tr>
            <td background="<?php echo base_url(); ?>templates/home/images/bg_mainkhung_left.jpg" style="padding-left:4px;" valign="top" >
                ...
                <table width="585" class="post_main" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('require_exper_post'); ?>:</td>
                        <td>
                            <select name="experience_job" id="experience_job" class="selectexper_formpost">
                                <option value="0" <?php if(!isset($experience_job)){ ?>selected="selected"<?php } ?>><?php echo $this->lang->line('none_post'); ?></option>
                            ...
                            <span class="exper_job"><?php echo $this->lang->line('year_exper_post'); ?></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="time_job" id="time_job" class="selecttime_formpost">
                                <option value="1" <?php if(isset($time_job) && $time_job == '1'){echo 'selected="selected"';}elseif(!isset($time_job)){echo 'selected="selected"';} ?>><?php echo $this->lang->line('time_job_1_post'); ?></option>
                                <option value="2" <?php if(isset($time_job) && $time_job == '2'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('time_job_2_post'); ?></option>
                                <option value="3" <?php if(isset($time_job) && $time_job == '3'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('time_job_3_post'); ?></option>
                                <option value="4" <?php if(isset($time_job) && $time_job == '4'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('time_job_4_post'); ?></option>
                                <option value="5" <?php if(isset($time_job) && $time_job == '5'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('time_job_5_post'); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('time_surrend_post'); ?>:</td>
                        <td>
                            <select name="day_job" id="day_job" class="selectdate_formpost">
                                ...
                                <?php }elseif($day == (int)date('d') && $day_job == ''){ ?>
                                <option value="<?php echo $day; ?>" selected="selected"><?php echo $day; ?></option>
                                <?php }else{ ?>
                            ...
                            <select name="month_job" id="month_job" class="selectdate_formpost">
                                ...
                                <?php }elseif($month == $nextMonth && $month_job == ''){ ?>
                                <option value="<?php echo $month; ?>" selected="selected"><?php echo $month; ?></option>
                                <?php }else{ ?>
                            ...
                            <select name="year_job" id="year_job" class="selectdate_formpost">
                                ...
                                <?php }elseif($year == $nextYear && $year_job == ''){ ?>
                                <option value="<?php echo $year; ?>" selected="selected"><?php echo $year; ?></option>
                                <?php }else{ ?>
                            ...
                            <img src="<?php echo base_url(); ?>templates/home/images/help_post.gif" onmouseover="ddrivetip('<?php echo $this->lang->line('time_currend_tip_help_post') ?>',350,'#F0F8FF');" onmouseout="hideddrivetip();" class="img_helppost" />
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="bestcontact_job" id="bestcontact_job" class="selectbestcontact_formpost">
                                <option value="1" <?php if(isset($bestcontact_job) && $bestcontact_job == '1'){echo 'selected="selected"';}elseif(!isset($bestcontact_job)){echo 'selected="selected"';} ?>><?php echo $this->lang->line('best_contact_1_contact_post'); ?></option>
                                <option value="2" <?php if(isset($bestcontact_job) && $bestcontact_job == '2'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('best_contact_2_contact_post'); ?></option>
                                <option value="3" <?php if(isset($bestcontact_job) && $bestcontact_job == '3'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('best_contact_3_contact_post'); ?></option>
                                <option value="4" <?php if(isset($bestcontact_job) && $bestcontact_job == '4'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('best_contact_4_contact_post'); ?></option>
                                <option value="5" <?php if(isset($bestcontact_job) && $bestcontact_job == '5'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('best_contact_5_contact_post'); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" style="padding-top:7px;">
                            <img src="<?php echo base_url().$imageCaptchaPostJob; ?>" width="151" height="30" /><br />
                    ...
                    <tr>
                        ...
                        <td height="30" valign="bottom" align="center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><input type="button" onclick="CheckInput_PostJob();" name="submit_postjob" value="<?php echo $this->lang->line('button_agree_post'); ?>" class="button_form" /></td>
                                    <td width="15"></td>
