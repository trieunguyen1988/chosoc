        ...
        <tr>
            <td background="<?php echo base_url(); ?>templates/home/images/bg_mainkhung_left.jpg" style="padding-left:4px;" valign="top" >
                ...
                <table width="585" class="post_main" cellpadding="0" cellspacing="0" border="0">
                	...
                	<?php }else{ ?>
                    <?php if($successPostProduct == false){ ?>
                    <form name="frmPostPro" method="post" enctype="multipart/form-data">
                    <tr>
                    ...
                    <tr>
                        <td width="150" valign="top" class="list_post"><font color="#FF0000"><b>*</b></font> <?php echo $this->lang->line('cost_post'); ?>:</td>
                        <td>
                            <input type="text" value="<?php if(isset($cost_pro)){echo $cost_pro;} ?>" name="cost_pro" id="cost_pro" maxlength="19" class="inputcost_formpost" onkeyup="FormatCurrency('DivShowCost','currency_pro',this.value); BlockChar(this,'NotNumbers');" onclick="ChangeCheckBox('nonecost_pro'); ChangeStyleTextBox('cost_pro','DivShowCost',document.getElementById('nonecost_pro').checked);" onfocus="ChangeStyle('cost_pro',1)" onblur="ChangeStyle('cost_pro',2)" />
                            <select name="currency_pro" id="currency_pro" class="selectcurrency_formpost" onchange="FormatCurrency('DivShowCost','currency_pro',document.getElementById('cost_pro').value)">
                                ...
                                <option value="USD" <?php if(isset($currency_pro) && $currency_pro == 'USD'){echo 'selected="selected"';} ?>><?php echo $this->lang->line('usd_post'); ?></option>
                            </select>
                            ...
                            <div class="none_cost">
                                ...
                                <?php echo $this->lang->line('none_cost_post'); ?> <font color="#FF0000">(<?php echo $this->lang->line('call_post'); ?>)</font>&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="day_pro" id="day_pro" class="selectdate_formpost">
                                ...
                                <?php }elseif($endday == (int)date('d') && $day_pro == ''){ ?>
                                <option value="<?php echo $endday; ?>" selected="selected"><?php echo $endday; ?></option>
                                <?php }else{ ?>
                            ...
                            <select name="month_pro" id="month_pro" class="selectdate_formpost">
                                ...
                                <?php }elseif($endmonth == $nextMonth && $month_pro == ''){ ?>
                                <option value="<?php echo $endmonth; ?>" selected="selected"><?php echo $endmonth; ?></option>
                                <?php }else{ ?>
                            ...
                            <select name="year_pro" id="year_pro" class="selectdate_formpost">
                                ...
                                <?php }elseif($endyear == $nextYear && $year_pro == ''){ ?>
                                <option value="<?php echo $endyear; ?>" selected="selected"><?php echo $endyear; ?></option>
                                <?php }else{ ?>
                    ...
                    <tr>
                        <td width="150" valign="top" class="list_post"><?php echo $this->lang->line('image_1_post'); ?>:</td>
                        <td>
                    ...
                    <tr>
                        <td width="150" valign="top" class="list_post"><?php echo $this->lang->line('image_2_post'); ?>:</td>
                        <td>
                    ...
                    <tr>
                        <td width="150" valign="top" class="list_post"><?php echo $this->lang->line('image_3_post'); ?>:</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td height="30" valign="bottom" align="center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><input type="button" onclick="CheckInput_PostPro();" name="submit_postpro" value="<?php echo $this->lang->line('button_agree_post'); ?>" class="button_form" /></td>
                                    <td width="15"></td>
                                    <td><input type="reset" name="reset_postpro" value="<?php echo $this->lang->line('button_reset_post'); ?>" class="button_form" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
