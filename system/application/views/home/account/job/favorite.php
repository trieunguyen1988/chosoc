    ...
    <table width="803" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td background="<?php echo base_url(); ?>templates/home/images/bg_topkhung_ac.png" height="30">
                <div class="tile_modules"><?php echo $this->lang->line('title_job_favorite'); ?></div>
            </td>
        </tr>
                ...
                <table border="0" width="788" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'f1f9ff';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                        ...
                        <td height="32" class="line_account_2">
                            <a class="menu_1" href="<?php echo base_url(); ?>job/field/<?php echo $favoriteJobArray->job_field; ?>/detail/<?php echo $favoriteJobArray->job_id; ?>" title="<?php echo $this->lang->line('detail_tip'); ?>">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center" id="boxfilter_account">
                            ...
                            <img src="<?php echo base_url(); ?>templates/home/images/icon_filter.gif" onclick="ActionSearch('<?php echo base_url(); ?>account/job/favorite/', 0)" border="0" style="cursor:pointer;" title="<?php echo $this->lang->line('search_tip'); ?>" />
                        </td>
        ...
        <?php }else{ ?>
        <tr>
        	<td class="none_record" align="center" background="<?php echo base_url(); ?>templates/home/images/bg_mainkhung_ac.jpg"><?php echo $this->lang->line('none_record_job_favorite'); ?></td>
		</tr>
        <?php } ?>
        <tr>
