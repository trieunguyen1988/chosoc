                            ...
                            <td align="center">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/advertise/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/advertise/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                        ...
                                        <td class="detail_list">
                                            ...
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_expand.gif" onmouseover="ddrivetip('<?php echo $this->lang->line('email_tip_defaults'); ?>&nbsp;<?php echo $advertiseArray->adv_email; ?><br><?php echo $this->lang->line('phone_tip_defaults') ?>&nbsp;<?php echo $advertiseArray->adv_phone; ?>',300,'#F0F8FF');" onmouseout="hideddrivetip();" style="cursor:pointer;" border="0" />
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php if($advertiseArray->adv_position == 1){ ?>
                                            <?php echo $this->lang->line('header_defaults') ?>
                                            <?php }elseif($advertiseArray->adv_position == 2){ ?>
                                            <?php echo $this->lang->line('footer_defaults') ?>
                                            <?php }elseif($advertiseArray->adv_position == 3){ ?>
                                            <?php echo $this->lang->line('left_defaults') ?>
                                            <?php }elseif($advertiseArray->adv_position == 4){ ?>
                                            <?php echo $this->lang->line('right_defaults') ?>
                                            <?php }elseif($advertiseArray->adv_position == 5){ ?>
                                            <?php echo $this->lang->line('top_defaults') ?>
                                            <?php }else{ ?>
                                        ...
                                        <td class="detail_list" style="text-align:center;">
                                            ...
                                            <img src="<?php echo base_url(); ?>templates/admin/images/active.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/deactive/id/<?php echo $advertiseArray->adv_id; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                            <?php }else{ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/deactive.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/active/id/<?php echo $advertiseArray->adv_id; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                            <?php } ?>
                                        </td>
