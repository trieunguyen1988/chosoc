                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="160" align="left">
                                            <input type="text" name="keyword" id="keyword" value="<?php if($haveAdsBad == true){echo $keyword;} ?>" maxlength="100" class="input_search" onfocus="ChangeStyle('keyword',1)" onblur="ChangeStyle('keyword',2)" />
                                        </td>
                                        ...
                                        <td align="left">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/ads/bad/',1)" title="<?php echo $this->lang->line('search_tip'); ?>" />
                                        </td>
                                        <!---->
                                        ...
                                        <td width="25" align="right">
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_search.gif" border="0" style="cursor:pointer;" onclick="ActionSearch('<?php echo base_url(); ?>administ/ads/bad/',2)" title="<?php echo $this->lang->line('filter_tip'); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <!--END Search-->
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                        ...
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>ads/category/<?php echo $adsArray->ads_category; ?>/detail/<?php echo $adsArray->ads_id; ?>" target="_blank" title="<?php echo $this->lang->line('view_tip'); ?>">
                                                <?php echo $adsArray->ads_title; ?>
                                            </a>
                                            <span style="color:#0C0; font-style:italic;">(<?php echo $adsArray->ads_view; ?>)</span>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/icon_expand.gif" onclick="Popup('<?php echo base_url(); ?>administ/ads/bad/detail/<?php echo $adsArray->ads_id; ?>', 654, 320)" onmouseover="ddrivetip('<?php echo $this->lang->line('view_detail_tip_help_bad'); ?>',265,'#F0F8FF');" onmouseout="hideddrivetip();" style="cursor:pointer;" border="0" />
                                        </td>
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>administ/province/edit/<?php echo $adsArray->pre_id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                                <?php echo $adsArray->pre_name; ?>
                                            </a>
                                        </td>
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>administ/user/edit/<?php echo $adsArray->use_id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                        ...
                                        <td class="detail_list">
                                            <a class="menu" href="<?php echo base_url(); ?>administ/category/edit/<?php echo $adsArray->cat_id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                                <?php echo $adsArray->cat_name; ?>
                                            </a>
                                        </td>
                                        <td class="detail_list" style="text-align:center;">
                                            <?php if($adsArray->ads_status == 1){ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/active.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/deactive/id/<?php echo $adsArray->ads_id; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                            <?php }else{ ?>
                                            <img src="<?php echo base_url(); ?>templates/admin/images/deactive.png" onclick="ActionStatus('<?php echo $statusUrl; ?>/status/active/id/<?php echo $adsArray->ads_id; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                            <?php } ?>
                                        </td>
