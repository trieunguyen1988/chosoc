...
<table width="650" border="0" cellpadding="0" cellspacing="0">
	...
	<tr bgcolor="#E1F0FF">
        ...
        <td class="title_detail_bad">
        	...
        	<img src="<?php echo base_url(); ?>templates/admin/images/icon_delete_bad.gif" onclick="ActionDelete('frmDetailBadAds_<?php echo $idDiv; ?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('delete_tip_detail_bad'); ?>" />
        </td>
    </tr>
    <tr bgcolor="#F7F7F7">
