...
- Sản xuất, mua bán, thiết kế, thi công và phát triển phần mềm.
- Kinh doanh các dịch vụ trực tuyến, quảng bá website, quảng cáo trực tuyến...
- Mua bán, sửa chữa, cài đặt máy tính, thiết bị viễn thông
- Dịch vụ tiếp thị và truyền thông quảng cáo';
const settingKeyword = '- Tư vấn thương hiệu - Tư vấn quản lý
- Tư vấn và thiết kế website, logo, nhãn hiệu, thiết kế in ấn …
- Quảng cáo thương mại - Thương mại điện tử
- Sản xuất, mua bán, thiết kế, thi công và phát triển phần mềm.
- Kinh doanh các dịch vụ trực tuyến, quảng bá website, quảng cáo trực tuyến...
...
const settingTimeSession = 15;
const settingTimeCache = 10;
const settingStopSite = '0';
const settingActiveAccount = '0';
const settingStopRegister = '0';
const settingStopRegisterVip = '0';
const settingStopRegisterShop = '0';
const settingExchange = 19500;
#Hien thi san pham
const settingProductNew_Home = 12;
const settingProductReliable_Home = 12;
const settingProductNew_Category = 20;
const settingProductReliable_Category = 12;
